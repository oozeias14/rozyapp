...
export default function AuthScreen({ onLoggedIn }) {
  ...
  async function handleCadastro() {
    ...
    if (dupPhone) {
      Alert.alert('Erro no cadastro', 'Este número de WhatsApp já está sendo usado por outra conta.');
      return;
    }
...
const styles = StyleSheet.create({
  container: { padding: 24, paddingTop: 5, backgroundColor: '#05070B', flexGrow: 1 },
  logoImg: { width: 350, height: 350, alignSelf: 'center', marginTop: -45, marginBottom: -55 },
